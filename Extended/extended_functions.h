...
#define LINUX_ULL 8							//The ULL must be this large to accomodate the hashing number
...
board_struct *attempt_to_move(board_struct *parent_board, board_struct *current_board, success_failure *success_index, int row_coordinate, int col_coordinate,
							  full_empty hashing_array[VERY_LARGE_NUMBER], int row, int col, int row_incr, int col_incr);
